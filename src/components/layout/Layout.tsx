...
function FabChoiceSheet() {
  const { fabChoiceOpen, closeFabChoice } = useFab()
  return (
      ...
      <div style={{ padding: '8px 20px 32px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        >
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ fontSize: 13, color: '#5c6070', marginTop: 2 }}>Dostupné v Milestone 3</div>
          </div>
        </button>
        ...
        >
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ fontSize: 13, color: '#5c6070', marginTop: 2 }}>Dostupné v Milestone 4</div>
          </div>
        </button>
      </div>
    </BottomSheet>
...
export default function Layout() {
  const { carFormOpen, closeCarForm, editingCar } = useFab()
